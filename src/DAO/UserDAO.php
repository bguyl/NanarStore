...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @return \NanarStore\Domain\User|throws an exception if no matching user is found
     */
     ...
     *
     * @param \NanarStore\Domain\User $user The user to save
     */
